...
class AppConfig {
  // ==================== APP IDENTITY ====================
  static const String appName = 'Rukko.in';
  static const String appLogoPath = 'assets/images/logo.png';
  static const String splashGifPath = 'assets/images/splash.gif';

  // ==================== COLORS & THEME ====================
  static const Color primaryColor = Color(0xFF244739); // Indigo
  static const Color secondaryColor = Color(0xFF244739); // Purple
  static const Color accentColor = Color(0xFF244739); // Pink
  ...
  static const String webUrl = 'https://rukkoo.in/';
